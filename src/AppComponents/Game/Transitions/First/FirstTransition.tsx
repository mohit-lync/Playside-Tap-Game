...
export const FirstTransition = () => {
  ...
  return (
    ...
    // <div className=' absolute w-full flex items-center bg-level1TransitionBg justify-center flex-col h-screen -top-14 '
        onAnimationStart={
            ()=>{
                setTimeout(()=>{
    ...
    >
        ...
        <div>
            <img src={ball} className='w-16 ml-0.5 mb-0.5' alt="" />
        </div>
    </div>
  )
}
